...
| **claude-seo** | SEO toolkit with 24 specialist sub-skills (upstream v2.0) — full site… | `npx claude-skills-vault install claude-seo` |
...
| **frontend-design** | Guidance for distinctive, intentional visual design when building new… | `npx claude-skills-vault install frontend-design` |
...
| **project-change-log** | Maintain a CHANGELOG.md following the Keep a Changelog standard. Use … | `npx claude-skills-vault install project-change-log` |
...
| **semantic-coding** | Replace hardcoded styles with semantic design tokens (colors, typogra… | `npx claude-skills-vault install semantic-coding` |
